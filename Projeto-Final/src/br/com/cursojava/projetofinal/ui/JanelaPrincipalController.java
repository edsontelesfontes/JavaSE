...
public class JanelaPrincipalController {
  ...
  void pesquisaFuncionarioOnAction(ActionEvent event) throws IOException {
    FXMLLoader loader = new FXMLLoader(getClass().getResource(
        "/resource/PesquisaFuncionario.fxml"));
    Parent parent = loader.load();
    pnlRaiz.setCenter(parent);
  ...
  @FXML
  void estatisticasOnAction(ActionEvent event) throws IOException {
    FXMLLoader loader = new FXMLLoader(getClass().getResource(
        "/resource/Estatisticas.fxml"));
    Parent parent = loader.load();
    pnlRaiz.setCenter(parent);
    stage.setTitle("Projeto Final - Estatísticas salariais");
  }
